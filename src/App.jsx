...
function SectionProgressNav() {
  ...
  const renderScientificSymbol = (symbol) => {
    if (symbol === "start") {
      return (
        <span
          className="section-progress-nav-symbol section-progress-nav-symbol-start"
          aria-hidden="true"
        />
      );
    }
    ...
    if (symbol === "ecosystem") {
      return (
        <span
          className="section-progress-nav-symbol section-progress-nav-symbol-ecosystem"
          aria-hidden="true"
        >
          <span className="section-progress-nav-node section-progress-nav-node-a" />
          <span className="section-progress-nav-node section-progress-nav-node-b" />
          <span className="section-progress-nav-node section-progress-nav-node-c" />
          <span className="section-progress-nav-link section-progress-nav-link-a" />
          <span className="section-progress-nav-link section-progress-nav-link-b" />
        </span>
      );
    }
    ...
    if (symbol === "compounds") {
      return (
        <span
          className="section-progress-nav-symbol section-progress-nav-symbol-compounds"
          aria-hidden="true"
        >
          <span className="section-progress-nav-node section-progress-nav-node-a" />
          <span className="section-progress-nav-node section-progress-nav-node-b" />
    ...
    if (symbol === "indications") {
      return (
        <span
          className="section-progress-nav-symbol section-progress-nav-symbol-indications"
          aria-hidden="true"
        >
          <span className="section-progress-nav-indication-ring" />
          <span className="section-progress-nav-indication-core" />
        </span>
      );
    }
...
export default function App() {
  ...
  const observableSrc = useMemo(
    () => ({
      ...
      visual1EcosystemAndCompanyLandscape: `https://observablehq.com/embed/e3028f2577c04f9a@1416?cells=visual1EcosystemAndCompanyLandscape&api_key=ecf9f0bfb7b84e805b81fe519905418231789a18${visual1CompanyLandscapeParams}`,

      visual2IntroTransition: `https://observablehq.com/embed/e3028f2577c04f9a@1416?cells=visual2IntroTransition&api_key=2488895c619fa293677a0791309b410e6db31cb6`,
      
      visual2ChartUnitColumns1: `https://observablehq.com/embed/e3028f2577c04f9a@1416?cells=visual2ChartUnitColumns1&api_key=2488895c619fa293677a0791309b410e6db31cb6`,

      visual3IntroTransition: `https://observablehq.com/embed/e3028f2577c04f9a@1416?cells=visual3IntroTransition&api_key=2488895c619fa293677a0791309b410e6db31cb6`,

      visual3Chart: `https://observablehq.com/embed/e3028f2577c04f9a@1416?cells=visual3Chart&api_key=715f3cbfdfce0e9356d08d20a074b04d91101685`,

      visual4IntroTransition: `https://observablehq.com/embed/e3028f2577c04f9a@1416?cells=visual4IntroTransition&api_key=2488895c619fa293677a0791309b410e6db31cb6`,

      visual4PhaseChart: `https://observablehq.com/embed/e3028f2577c04f9a@1416?cells=visual4PhaseChart&api_key=85cae8d02263045c184f5e4a5369f63938945a3e`
    }),
  ...
  return (
    <main className="site">
      ...
      <section
          className="story-section visual-story compound-story"
          id="compounds-overview"
        >
          <ObservableFrame
