...
export default function App() {
  ...
  const frameHeights = useMemo(() => {
    if (viewportWidth <= 900) {
      return {
        ...
        companyVisible: 776.25,
        companyIframe: 776.25,
        compoundVisible: 820,
        compoundIframe: 960,
  ...
  const observableSrc = useMemo(
    () => ({
      ...
      visual1CompanyLandscapePremium1: `https://observablehq.com/embed/e3028f2577c04f9a@1228?cells=visual1CompanyLandscapePremium1&api_key=d6c5994c875316f9fa9e7e21730d346553066d72${visual1CompanyLandscapeParams}`,
